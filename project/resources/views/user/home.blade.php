...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card note">
                <div class="card-header">Hey,    <b>{{ Auth::user()->name }}</b>!</div>

                <div class="card-body p-2">
                    You don't seem to be an admin!
                    <br> You can only add Books and Cds!! 
                </div>
            </div>
        </div>
    </div>
...
<div class="container hold">
    <div class="row">
        <div class="books col-3 mx-2  rounded bg-smooth shadow-lg max-height ">
            ...
            <div class="card my-4 shadow-lg  ">
                <ul class="p-2">
                    ...
                    {{-- <div class="select float-right">
                        <li> <a href="{{route('user_editbook', $book -> id) }}"><button type="button"
        ...
        <div class="create col-5 mx-2 p-4  rounded bg-smooth  shadow-lg max-height  ">
            <h1 class="unselectable text-center">Create</h1>

            <form action="{{route('user_addproduct')}}" method='post'>
                @csrf
        ...
        <div class=" cds col-3 mx-2 bg-smooth rounded shadow-lg max-height">
            ...
            <div class="card my-4 shadow-lg">
                <ul class="p-2">
                    ...
                    {{-- <div class="select float-right">
                        <li> <a href="{{route('user_editcd', $cd -> id) }}"><button type="button"
                                    class="btn btn-primary">Select</button> </a></li>
                    </div> --}}
            </div>
            </ul>
